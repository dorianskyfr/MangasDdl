...
class AnimeSamaScraper(BaseScraper):
    ...
    def search(self, query: str) -> List[Manga]:
        ...
        alias_map = {
            # Manhwas & Webtoons
            "raeliana": "kanojo ga koushaku-tei ni itta riyuu",
            "the reason why raeliana ended up at the duke's mansion": "kanojo ga koushaku-tei ni itta riyuu",
            "comment raeliana a survécu au manoir du duc": "kanojo ga koushaku-tei ni itta riyuu",
            "comment raeliana a survécu au manoir wynknight": "kanojo ga koushaku-tei ni itta riyuu",
            "comment raeliana a survécu": "kanojo ga koushaku-tei ni itta riyuu",
            "tbate": "the beginning after the end",
            "orv": "lecteur omniscient",
            "lecteur omniscient": "lecteur omniscient",
            "omniscient reader": "lecteur omniscient",
            "omniscient readers viewpoint": "lecteur omniscient",
            "omniscient reader's viewpoint": "lecteur omniscient",
            "solo leveling": "solo leveling",
            "sl": "solo leveling",
            "tower of god": "tower of god",
            "tog": "tower of god",
            "god of high school": "the god of high school",
            "goh": "the god of high school",
            "nano machine": "nano machine",
            "magic emperor": "magic emperor",
            "mercenary enrollment": "mercenary enrollment",
            "eleceed": "eleceed",
            ...
            "mount hua": "return of the mount hua sect",
            "legend of the northern blade": "legend of the northern blade",
            "wind breaker": "wind breaker",
            "lookism": "lookism",
            "greatest estate developer": "the greatest estate developer",
            "the greatest estate developer": "the greatest estate developer",
            ...
            "moi quand je me reincarne en slime": "tensei shitara slime datta ken",
            ...
            "danmachi": "danmachi la legende des famillias",
